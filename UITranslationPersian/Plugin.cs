...
namespace UITranslationPersian
{
    [BepInPlugin("akarnokd.theplanetcraftermods.uitranslationpersian", "(UI) Persian Translation", "1.0.0.0")]
    public class Plugin : BaseUnityPlugin
    {
        const string languageKey = "persian";
        ...
        private void Awake()
        {
            ...
            string[] text = File.ReadAllLines(dir + "\\labels-fa.txt", Encoding.UTF8);
